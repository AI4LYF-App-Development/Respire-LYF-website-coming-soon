      ...
      <div className="layout-container mx-auto w-full max-w-[1500px] px-4 sm:px-6 lg:px-10 relative z-10">
          ...
          <div className="lg:col-span-5">
            <div className="h-full bg-[#101622] rounded-[2.5rem] p-10 lg:p-12 relative overflow-hidden flex flex-col justify-between shadow-2xl">
              ...
              <div className="relative z-10 mt-auto">
                <button 
                  onClick={() => {
                    trackButtonClick('Stay Tuned', 'footer')
                    setIsWaitlistModalOpen(true)
                  }}
                  className="w-full flex items-center justify-center gap-3 bg-white text-[#101622] rounded-xl px-4 py-3 hover:bg-gray-100 transition-colors group"
                >
        ...
        <div className="mb-20 pt-8">
          <div className="max-w-md">
            ...
            <ul className="space-y-2 text-[15px] text-slate-400 mb-4">
            ...
            <button 
              onClick={() => {
                trackButtonClick('Get in Touch', 'footer')
        ...
        <div className="border-t border-white/10 pt-10 pb-16">
          ...
          This content is intended to inform, not to diagnose or treat. It is not a substitute for professional medical advice. Please consult a qualified healthcare provider for any health concerns.
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-[1280px] flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-5">
            <a 
              ...
              title="Follow Respire LYF on X (Twitter)"
            >
            ...
            <a 
              ...
              title="Follow Respire LYF on Facebook"
            >
            ...
            <a 
              ...
              title="Follow Respire LYF on Instagram"
            >
            ...
            <a 
              ...
              title="Subscribe to Respire LYF on YouTube"
            >
