      ...
      <AnimatePresence mode="wait">
        {!isLastQuestion ? (
          ...
          <motion.main
            ...
            className="flex-1 flex flex-col justify-center items-center w-full max-w-5xl px-6 relative z-10 min-h-screen"
          ...
          >
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              <motion.h1
                className="text-primary text-5xl md:text-8xl font-black tracking-tighter mb-10 font-display"
                style={{
                  textShadow: '0 0 20px rgba(80, 167, 226, 0.4), 0 0 40px rgba(80, 167, 226, 0.1)'
                }}
