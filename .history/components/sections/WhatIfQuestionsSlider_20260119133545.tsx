        ...
        {!isLastQuestion ? (
          ...
          >
            ...
            <div className="w-full text-center mb-6">
              <motion.h1
                className="text-primary text-5xl md:text-8xl font-black tracking-tighter uppercase font-display"
                style={{
            ...
            {/* Questions Slider */}
            <div className="w-full max-w-4xl mx-auto text-center min-h-[300px] md:min-h-[350px] flex items-center justify-center">
              <AnimatePresence initial={false} custom={direction} mode="wait">
                <motion.div
                  ...
                  className="w-full"
                >
                  <p className="text-charcoal text-3xl md:text-5xl lg:text-6xl font-medium leading-[1.2] tracking-tight min-h-[200px] md:min-h-[250px] flex items-center justify-center">
          ...
          >
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              <motion.h1
                className="text-primary text-5xl md:text-8xl font-black tracking-tighter uppercase mb-10 font-display"
                style={{
                  textShadow: '0 0 20px rgba(80, 167, 226, 0.4), 0 0 40px rgba(80, 167, 226, 0.1)'
                }}
