      ...
      <AnimatePresence mode="wait">
        {!isLastQuestion ? (
          ...
          >
            ...
            {/* Questions Slider */}
            <div className="w-full max-w-4xl mx-auto text-center flex items-center justify-center min-h-[200px] md:min-h-[250px]">
              <AnimatePresence initial={false} custom={direction} mode="wait">
                <motion.div
                  ...
                  className="w-full flex items-center justify-center min-h-[150px]"
                >
