      ...
      <AnimatePresence mode="wait">
        {!isLastQuestion ? (
          ...
          >
            ...
            {/* Questions Slider */}
            <div className="w-full max-w-4xl mx-auto text-center h-[350px] md:h-[400px] flex items-center justify-center">
              <AnimatePresence initial={false} custom={direction} mode="wait">
                ...
                >
                  <p className="text-charcoal text-3xl md:text-5xl lg:text-6xl font-medium leading-[1.2] tracking-tight text-center">
