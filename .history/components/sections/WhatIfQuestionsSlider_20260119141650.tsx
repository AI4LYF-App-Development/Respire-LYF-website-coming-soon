...
export default function WhatIfQuestionsSlider({ onJoinWaitlist }: WhatIfQuestionsSliderProps) {
  ...
  useEffect(() => {
    ...
    }, 8000) // Change question every 6 seconds
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center" style={{ background: 'radial-gradient(circle at center, rgba(80, 167, 226, 0.08) 0%, rgba(255, 255, 255, 1) 75%)' }}>
      ...
      {/* Header */}
      <header className="w-full max-w-7xl mx-auto px-6 pt-6 pb-4 flex items-center justify-between sticky top-0 z-30 flex-shrink-0 bg-white/95 backdrop-blur-sm shadow-sm">
