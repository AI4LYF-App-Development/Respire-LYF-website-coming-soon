            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              ...
              >
                <p className="text-charcoal text-3xl md:text-4xl lg:text-5xl font-medium leading-tight tracking-tight">
                  your <span className="text-primary font-bold">health determinants (HD)</span> <br/>
                  could be mapped to <br/>
                  your <span className="text-primary font-bold">health indicators (HI)</span> <br/>
                  for the <span className="font-bold">clarity</span> you and your doctor need?
                </p>
              </motion.div>
            </div>
