  ...
  return (
    <footer id="about" className="relative bg-black pt-24 pb-0 border-t border-white/5 overflow-hidden">
      ...
      <div className="layout-container mx-auto w-full max-w-[1500px] px-4 sm:px-6 lg:px-10 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-20 pt-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Icon name="verified_user" size={20} className="text-primary" />
              <h3 className="text-lg font-bold text-white">Regulatory Approach</h3>
            </div>
            <p className="text-slate-400 leading-relaxed text-[15px]">
              Designed as a wellness product with specific safeguards. No predictions or risk scoring—all insights are observational, reflecting correlations in historical data while maintaining clinical alignment.
            </p>
          </div>
          
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Icon name="science" size={22} className="text-primary" />
              <h3 className="text-lg font-bold text-white">Scientific Evidence</h3>
            </div>
            <p className="text-slate-400 leading-relaxed text-[15px]">
              Our multi-determinant analysis is grounded in peer-reviewed respiratory research. We utilize clinically-aligned algorithms to observe patterns, ensuring all insights are backed by rigorous scientific principles without making predictive claims.
            </p>
            <a href="/reference-hub" className="inline-flex items-center gap-1.5 mt-4 text-primary font-bold hover:gap-3 transition-all">
              Reference Hub <Icon name="arrow_forward" size={18} className="text-primary" />
            </a>
          </div>
        ...
        <div className="border-t border-white/10 pt-10 pb-16">
          ...
          <p className="text-slate-400 leading-relaxed text-[15px]">
            The MD-RIC is not FDA-cleared as a medical device. This platform is for informational and educational purposes only. It does not constitute medical advice, diagnosis, or treatment. All correlations represent observational findings from user-generated data—they do not establish causation. Individual responses vary significantly. All health-related decisions should be made in consultation with qualified healthcare professionals.
          </p>
        </div>
      </div>
