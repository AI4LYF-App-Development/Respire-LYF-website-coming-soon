        ...
        <div className="mb-20 pt-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6">
              <span className="text-[15px] text-slate-400">Questions about MD-RIC?</span>
              <span className="text-[15px] text-slate-400">Partnership inquiries?</span>
              <span className="text-[15px] text-slate-400">Healthcare provider collaboration?</span>
